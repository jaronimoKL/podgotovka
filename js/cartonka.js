...
const deleteProducts = (productParent) => {
    ...
    document.querySelector(`.product[data-id="${id}"]`).querySelector('.buy').disabled = false;
...
productBtn.forEach(el => {
    ...
    el.addEventListener('click', (e) => {
        ...
        let img = parent.querySelector('.slier-nav__img').getAttribute('src');
        let title = parent.querySelector('.title-product').textContent;
        let priceString = priceWithoutSpaces(parent.querySelector('.price__current').textContent);
        let priceNumber = parseInt(priceWithoutSpaces(parent.querySelector('.price__current').textContent));
...
const deleteOrderProducts = (productOrderParent) => {
    ...
    // document.querySelector(`.product[data-id="${id}"]`).querySelector('.buy').disabled = true;
